...
impl<T> RawTable<T> {
    ...
    unsafe fn new_uninitialized(
        ...
        Ok(Self {
            table: RawTableInner::new_uninitialized(buckets, fallability, layout, ctrl_offset)?,
            marker: PhantomData,
        })
    }
    ...
    fn fallible_with_capacity(
        ...
        Ok(Self {
            table: RawTableInner::fallible_with_capacity::<T>(capacity, fallability)?,
            marker: PhantomData,
        })
    }
    ...
    pub unsafe fn data_end(&self) -> NonNull<T> {
        NonNull::new_unchecked(self.table.ctrl.as_ptr() as *mut T)
    }
    ...
    fn resize(
        ...
        unsafe {
            ...
            let mut new_table = RawTableInner::fallible_with_capacity::<T>(capacity, fallability)?;
...
impl RawTableInner {
    ...
    fn fallible_with_capacity<T>(
        ...
        if capacity == 0 {
            ...
            unsafe {
                ...
                Self::fallible_with_capacity_inner(buckets, fallability, layout, ctrl_offset)
            }
        }
    }
    ...
    unsafe fn fallible_with_capacity_inner(
        ...
        let result = Self::new_uninitialized(buckets, fallability, layout, ctrl_offset)?;
